...
# Function: get_final - Helper routine for get final logic.
# Parameters: `results` is results input value; `number_aux` is number aux input value; `number_up` is number up input value; `number_down` is number down input value.
